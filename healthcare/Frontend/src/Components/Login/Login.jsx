      ...
      >
        ...
        <div className="form-container sign-in-container">
          <form className="auth-form login-form" onSubmit={handleLoginSubmit}>
            ...
            <Link to="/loginadmin" className="text-link">
              Are you an admin?
            </Link>
            <Link to="/doctorlogin" className="text-link">
              Are you a doctor?
            </Link>
            <Link to="/forget_password" className="text-link">
              Forget Password?
            </Link>
          </form>
        </div>
        ...
        <div className="overlay-container">
          <div className="overlay">
            <div className="overlay-panel overlay-left">
              ...
              <button className="ghost" type="button" onClick={handleSignInClick}>
                Sign In
              </button>
            </div>
            ...
            <div className="overlay-panel overlay-right">
              ...
              <button className="ghost" type="button" onClick={handleSignUpClick}>
                Sign Up
              </button>
            </div>
          </div>
